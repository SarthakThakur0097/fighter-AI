...
DATA_PATH = os.environ.get('DATA_PATH', 
    r'C:\Users\Sarthak\Documents\ML\fighter-beta\mma\notebooks\02_features\data')
...
def predict_method(f1_name, f2_name, as_of_date=None):
    ...
    try:
        ...
        def get_sub_stats(fid):
            ...
            if len(r) == 0:
                return {'sub_att_per_fight': 0.0, 'td_per_fight': 0.0, 'ctrl_per_fight': 0.0}
            r = r.iloc[0]
        ...
        row['diff_sub_att_per_fight'] = f1_sub['sub_att_per_fight'] - f2_sub['sub_att_per_fight']
        ...
        row['max_sub_att_per_fight']  = max(f1_sub['sub_att_per_fight'], f2_sub['sub_att_per_fight'])
